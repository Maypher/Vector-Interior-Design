...
<div class="bg-vector-black relative hidden md:block">
	...
	>
		...
		>
			...
			<li class="w-fit">
				<a href="/proyectos" class="hover-link">Proyectos</a>
			</li>
			<li class="w-fit">
				<a href="/proyectos/esculturas" class="hover-link">Esculturas</a>
			</li>
			<li class="w-fit">
				<a
					href="#contact"
...
Cada proyecto es una oportunidad para crear ambientes con identidad y armonía enfocados en proporcionar confort, funcionalidad y distinción. Me involucro en cada una de sus etapas, prestando atención minuciosa a los detalles porque son ellos los que marcan la diferencia.`}
				...
				<p class="font-Nexa mr-5 mt-5 text-right text-sm text-vector-cream">Tony Quintero Gerik</p>
			</figcaption>
		</figure>
		<button
