<script lang="ts">
	...
	async function deleteProject() {
		...
		`)
			...
			if (deletedProject) goto('/proyectos/');
...
<div class="bg-vector-black py-5 lg:flex gap-x-10 lg:px-10 overflow-y-hidden header-screen">
	...
	<div class="grow flex h-full flex-col justify-between">
		...
		<div class="h-full my-10 lg:my-0">
			...
			<div class="max-h-9/10 overflow-y-scroll">
				...
				<div class="sticky bottom-0">
					...
					<a
						href={`/proyectos/${projectData.id}/ambientes/crear/`}
		...
		<div class="mx-auto">
			<EditorLinks
				mobileUrl={`/proyectos/${projectData.id}/movil`}
				desktopUrl={`/proyectos/${projectData.id}/escritorio`}
			/>
		</div>
	</div>
</div>
